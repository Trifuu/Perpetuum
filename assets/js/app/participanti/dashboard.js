...
$(document).ready(function () {
    ...
    $("#participanti_table").on("click", ".deschide", function () {
        ...
        if (detalii.includes(id)) {
            ...
            elem_tr.after("<tr class='append" + id + "'>\n\
                        ...
                        <tr class='append" + id + "'>\n\
                            <td>4</td>\n\
                            <td style='word-wrap: break-word;'>" + participant["nume4"] + "</td>\n\
                            <td>" + participant["prenume4"] + "</td>\n\
                            <td>" + participant["email4"] + "</td>\n\
                            <td>" + participant["telefon4"] + "</td>\n\
                            <td></td>\n\
                        </tr>");
        }
    });
    ...
    function convertToCSV(object) {
        ...
        'Nume  membru4,Telefon  membru4,Email  membru4,'+
        'Comentariu,Link CV,Data inscriere\r\n';
        for (var i = 0; i < object.length; i++) {
            ...
            str += object[i].nume4.replace(/[,;]/g , " ") + " ";
            str += object[i].prenume4.replace(/[,;]/g , " ") + ",";
            str += object[i].telefon4.replace(/[,;]/g , " ") + ",";
            str += object[i].email4.replace(/[,;]/g , " ") + ",";
