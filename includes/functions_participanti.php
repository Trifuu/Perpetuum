...
function add_participanti($echipa, $nume1, $prenume1, $email1, $telefon1, $nume2, $prenume2, $email2, $telefon2, $nume3, $prenume3, $email3, $telefon3, $nume4, $prenume4, $email4, $telefon4, $link_cv, $comentariu) {
    global $db;
    try {
        $stmt = $db->prepare("insert into `participanti` (`echipa`,`nume1`,`prenume1`,`email1`,`telefon1`,"
                ...
                . "                                         `nume4`,`prenume4`,`email4`,`telefon4`,"
                . "                                         `link_cv`,`comentariu`,`data_inscriere`"
                . "                                     ) values ("
        ...
        $stmt->bindParam(':telefon2', $telefon2, PDO::PARAM_STR, 15);
        $stmt->bindParam(':nume4', $nume4, PDO::PARAM_STR, 64);
        $stmt->bindParam(':prenume4', $prenume4, PDO::PARAM_STR, 64);
        $stmt->bindParam(':email4', $email4, PDO::PARAM_STR, 64);
        $stmt->bindParam(':telefon4', $telefon4, PDO::PARAM_STR, 15);
...
function verify_echipa_email($email1, $email2, $email3, $email4) {
    ...
    if ($email4 != "" && verify_email($email4) != null) {
        return $email4;
    }
    return false;
}

function verify_echipa_telefon($telefon1, $telefon2, $telefon3, $telefon4) {
    ...
    if ($telefon4 != "" && verify_telefon($telefon4) != null) {
        return $telefon4;
    }
    return false;
}
