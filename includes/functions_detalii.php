...
function insert_detalii($id_echipa, $tricou1, $tricou2, $tricou3, $tricou4, $vegetarieni, $vegani, $preferinte, $observatii, $mesaj) {
    global$db;
    try {
        $stmt = $db->prepare("insert into detalii (id_echipa,tricou1,tricou2,tricou3,tricou4,"
                . "vegetarieni,vegani,preferinte,observatii,mesaj)"
                . " values (:id_echipa,:tricou1,:tricou2,:tricou3,:tricou4,"
                . ":vegetarieni,:vegani,:preferinte,:observatii,:mesaj)");
        ...
        $stmt->bindParam(":tricou4", $tricou4, PDO::PARAM_STR);
...
function update_detalii_echipa($id_echipa, $tricou1, $tricou2, $tricou3, $tricou4, $vegetarieni, $vegani, $preferinte, $observatii, $mesaj) {
    global $db;
    try {
        $stmt = $db->prepare("update detalii set id_echipa=:id_echipa,tricou1=:tricou1,tricou2=:tricou2"
                . ",tricou3=:tricou3,tricou4=:tricou4,vegetarieni=:vegetarieni,vegani=:vegani,preferinte=:preferinte"
                . ",observatii=:observatii,mesaj=:mesaj where id_echipa=:id_echipa");
        $stmt->bindParam(":id_echipa", $id_echipa, PDO::PARAM_INT);
        $stmt->bindParam(":tricou1", $tricou1, PDO::PARAM_STR);
        $stmt->bindParam(":tricou2", $tricou2, PDO::PARAM_STR);
        $stmt->bindParam(":tricou3", $tricou3, PDO::PARAM_STR);
