...
INSERT INTO `user` (`id`,`nume`, `prenume`, `parola`, `email`, `tel`, `sid`, `categorie`) VALUES
    (1,"Trifu", "Marius", "a80b568a237f50391d2f1f97beaf99564e33d2e1c8a2e5cac21ceda701570312", "trifumarius01@gmail.com", "0764310664", "4js66jribkk2tduot8cutr8aj0", "super admin"),
    (2,"Ionel", "Bogdan", "a80b568a237f50391d2f1f97beaf99564e33d2e1c8a2e5cac21ceda701570312", "ionelbogdan@gmail.com", "0764852345","0", "admin");
...
CREATE TABLE IF NOT EXISTS `participanti` (
  ...
  `nume4` VARCHAR(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
  `prenume4` VARCHAR(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
  `email4` VARCHAR(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
  `telefon4` VARCHAR(15) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
  ...
  `stare_echipa` INT NOT NULL DEFAULT 3,
  `user_stare_change` VARCHAR(40) COLLATE utf8_unicode_ci NOT NULL DEFAULT "Default",
   PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE detalii ( 
    ...
    `observatii` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT "", 
    `mesaj` TEXT CHARACTER SET utf32 COLLATE utf32_unicode_ci NOT NULL DEFAULT "", 
